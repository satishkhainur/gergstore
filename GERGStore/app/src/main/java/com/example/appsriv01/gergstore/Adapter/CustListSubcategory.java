 ...
 */
public class CustListSubcategory extends BaseAdapter {
  ...
  //  private final int[] Imageid;
    public CustListSubcategory(Context c, String[] text1, String[] text2, String[] text3, int[] Imageid){
        mContext = c;
        this.text1 = text1;
        this.text2 = text2;
        this.text3 = text3;
   ...
   /* @Override
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rowView1 = inflater.inflate(R.layout.list_subcategory, null);
